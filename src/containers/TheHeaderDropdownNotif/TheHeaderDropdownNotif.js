...
const TheHeaderDropdownNotif = ({ t }) => {
  ...
  //@dev this is for listening socket example
  //@author dang.pmIT
  ...
  return (
    <CDropdown inNav className="c-header-nav-item mx-2">
      ...
      <CDropdownMenu placement="bottom-end" className={classes.menu}>
        <CDropdownItem header tag="div" color="light" className={classes.item}>
          <strong>{"Notification"}</strong>
        </CDropdownItem>
        <CDropdownItem tag="div" color="light" className={classes.item1}>
          <Tabs
            defaultActiveKey="1"
          ...
          >
            <Tabs.TabPane
              ...
              key="1"
            ></Tabs.TabPane>
            <Tabs.TabPane tab={t("Orders") + ` (${0})`} key="2"></Tabs.TabPane>
          </Tabs>
        </CDropdownItem>
        {/* {statusNotif == 1 &&
          orders &&
